...
const projects = [
    {
        id: 1,
        title: "React Job Protal",
        description: "Job Portal For React devs",
        image: "/projects/project1.png",
        tags: ["React", "Tailwind"],
        demoUrl: "#",
        githubUrl: "https://github.com/aaryangautam-dot/Myprojects.git",
    },

        {
        id: 2,
        title: "Text to Image Generator",
        description: "A responsive Website which converts text to image using ai",
    ...
    return (
        <section id ="projects" className="py-24 px-4 relative">
            <div className="container mx-auto max-w-5xl">
                ...
                <p className="text-center text-muteed-foreground mb-12 max-w-2xl mx-auto">
                            ...
                            <div className="p-6 ">
                                ...
                                <div className="flex jusitfy-between items-center">
                                   <div className="flex - space-x-3">
                                    ...
                                    target="_blank" className="text-foreground/80 hover:text-primary transiton-colors duration-300"> <ExternalLinkIcon size={20}/></a>

                                    <a href={projects.githubUrl}
                                    target="_blank" className="text-foreground/80 hover:text-primary transiton-colors duration-300"><GithubIcon size={20}/></a>
                                    </div> 
                                </div>
                            </div>
                        </div>
                ...
                <div className="text-center mt-12">
                    ...
                    target="_blank" 
                    href="https://github.com/aaryangautam-dot" >Check My Github <ArrowRight size={16}/></a>
                </div>
            </div>
        </section>
    );
